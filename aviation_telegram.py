...
def main():
    ...
    print("🔍 국내 항공 정보 검색 중...")
    korea_search = web_search(client, "2026년 대한민국 UAM eVTOL 항공부품 인증 정부과제 공고 국토부 방사청 산업부 중기부 경남 부산 대구 인천 서울 경기 지자체 항공 UAM 사업공고 K-UAM 그랜드챌린지 NTIS IRIS 항공인증 과제공고 K-Startup(k-startup.go.kr) 항공 UAM 드론 관련 사업공고 IRIS(iris.go.kr) 항공 과제공고 TIPS 팁스 창업기업 마감일 신규 등록 최근 공고 당일자", max_uses=8)
    print("✍️ 해외 브리핑 작성 중...")
