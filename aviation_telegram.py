...
def main():
    ...
    print("🔍 해외 항공 정보 검색 중...")
    global_search = web_search(client, "Search for latest FAA EASA aviation certification rule changes Advisory Circulars UAM eVTOL regulatory updates this week 2026. Also search for recent aviation accidents, crashes, incidents, and safety investigations worldwide in the past 3 days")
    print("🔍 국내 항공 정보 검색 중...")
    korea_search = web_search(client, "2026년 대한민국 UAM eVTOL 항공부품 인증 정부과제 공고 국토부 방사청 산업부 중기부 경남 부산 대구 인천 서울 경기 지자체 항공 UAM 사업공고 K-UAM 그랜드챌린지 NTIS IRIS 항공인증 과제공고 K-Startup(k-startup.go.kr) 항공 UAM 드론 관련 사업공고 IRIS(iris.go.kr) 항공 과제공고 TIPS 팁스 창업기업 마감일 신규 등록 최근 공고 당일자 최근 3일 이내 국내 항공 드론 헬기 사고 추락 결함 조사 안전 이슈 뉴스 산림청 소방청 국토부 항공철도사고조사위원회", max_uses=8)
    print("✍️ 해외 브리핑 작성 중...")
    m1 = client.messages.create(model="claude-haiku-4-5", max_tokens=3200,
                messages=[{"role":"user","content":f"항공 인증 전문가. 아래 [RSS]/[웹검색]은 실제 웹검색으로 수집한 오늘자 자료야. 너의 실시간 인터넷 접속 여부는 언급하지 말고 이 자료만 근거로 자신있게 작성해. 자료에 없는 내용은 추측하지 말고 해당 섹션은 생략해. 오늘({today}) 해외 항공 뉴스 텔레그램 메시지 작성.  오늘 날짜 기준으로 이미 지난 날짜의 행사나 마감된 공고는 언급하지 말고, 아직 유효한 최신 정보만 포함해줘. 구체적 사실 기반. 각 섹션은 먼저 핵심 사실을 불릿(•)으로 2~3개 정리하고, 그 아래에 짧은 줄글로 1~2문장 부연 설명을 붙여줘. 전문용어가 처음 나올 때는 괄호로 짧게 풀어써줘. 가능하면 출처 링크를 표시해줘.\n\n[RSS]\n{news_text}\n\n[웹검색]\n{global_search}\n\n형식:\n✈️ *AW항공브리핑 해외편 | {today}*\n[오늘 가장 중요한 소식을 임팩트 있게 한 줄로 요약한 후킹 헤드라인]\n\n📌 *핵심 요약*\n• 불릿1\n• 불릿2\n• 불릿3\n\n💡 *쉽게 이해하기*\n전문용어 없이 왜 중요한지 2~3문장으로 풀어서 설명\n\n🚨 *최근 항공 이슈*\n최근 3일 내 해외에서 발생한 항공기·드론·헬기 관련 사고·결함·조사 등 실제 이슈가 자료에 있으면 날짜·장소·현재 상황 포함해 구체적으로 1~2건 정리, 자료에 없으면 이 섹션 생략\n• 이슈1\n• 이슈2\n줄글로 인증·안전 관점의 시사점 1문장\n\n🚁 *UAM eVTOL 글로벌 동향*\n• 불릿1\n• 불릿2\n줄글 1~2문장\n\n📋 *FAA EASA 인증 변화*\n• 불릿1\n• 불릿2\n줄글 1~2문장\n\n💼 *글로벌 비즈니스 투자*\n• 불릿1\n• 불릿2\n줄글 1문장\n\n📓 *용어 정리*\n▷ 용어1: 짧은 설명\n▷ 용어2: 짧은 설명\n\n📈 *앞으로 지켜볼 것*\n① 포인트1\n② 포인트2\n③ 포인트3\n\n💬 *결론적으로*\n1~2문장으로 종합 정리\n\n🔗 *원문 링크*\n있으면 링크 나열, 없으면 이 섹션 생략"}])
    print("✍️ 국내 브리핑 작성 중...")
    m2 = client.messages.create(model="claude-haiku-4-5", max_tokens=3200,
                        messages=[{"role":"user","content":f"항공 인증 전문가. 오아래 [웹검색]은 실제 웹검색으로 수집한 오늘자 자료야. 너의 실시간 인터넷 접속 여부는 언급하지 말고 이 자료만 근거로 자신있게 작성해. 자료에 없는 내용은 추측하지 말고 해당 섹션은 생략해. 늘({today}) 국내 항공 동향 텔레그램 메시지 작성. 오늘 날짜 기준으로 이미 지난 날짜의 행사나 마감된 공고는 언급하지 말고, 아직 유효한 최신 정보만 포함해줘.  구체적 사실 기반. 각 섹션은 먼저 핵심 사실을 불릿(•)으로 2~3개 정리하고, 그 아래에 짧은 줄글로 1~2문장 부연 설명을 붙여줘. 전문용어가 처음 나올 때는 괄호로 짧게 풀어써줘. 가능하면 출처 링크를 표시해줘.\n\n[웹검색]\n{korea_search}\n\n형식:\n🇰🇷 *AW항공브리핑 국내편 | {today}*\n[오늘 가장 중요한 소식을 임팩트 있게 한 줄로 요약한 후킹 헤드라인]\n\n📌 *핵심 요약*\n• 불릿1\n• 불릿2\n• 불릿3\n\n💡 *쉽게 이해하기*\n전문용어 없이 왜 중요한지 2~3문장으로 풀어서 설명\n\n🚨 *최근 항공 이슈*\n최근 3일 내 국내에서 발생한 항공·드론·헬기 관련 사고·결함·조사 등 실제 이슈가 자료에 있으면 날짜·장소·현재 상황 포함해 구체적으로 1~2건 정리, 자료에 없으면 이 섹션 생략\n• 이슈1\n• 이슈2\n줄글로 인증·안전 관점의 시사점 1문장\n\n🏛️ *국토부 방사청 정책 동향*\n• 불릿1\n• 불릿2\n줄글 1~2문장\n\n📢 *정부 지자체 과제 공고* (K-Startup·IRIS·TIPS 등에서 항공·UAM·드론 관련 현재 접수중인 사업만 선별, 마감일과 출처 포함), 신규  공고 위주로, 이미 예전부터 계속 진행 중이던 사업은 중복이므로 제외\n• 과제명 및 내용\n• 과제명 및 내용\n\n🗺️ *지자체 항공 UAM 사업*\n• 지자체1 내용\n• 지자체2 내용\n\n📓 *용어 정리*\n▷ 용어1: 짧은 설명\n▷ 용어2: 짧은 설명\n\n📈 *앞으로 지켜볼 것*\n① 포인트1\n② 포인트2\n③ 포인트3\n\n💬 *결론적으로*\n1~2문장으로 종합 정리, 국내 기업에게 시사점 포함\n\n🔗 *원문 링크*\n있으면 링크 나열, 없으면 이 섹션 생략\n\n_AW인증솔루션 | 항공 규제 트렌드 선제 분석_"}])
    print("🎬 숏폼 소재 후보 작성 중...")
    m3 = client.messages.create(model="claude-haiku-4-5", max_tokens=2000,
        messages=[{"role":"user","content":f"항공 인증 콘텐츠 크리에이터. 아래 [뉴스]/[해외검색]/[국내검색] 자료를 검토해서 숏폼 영상이나 카드뉴스로 만들기 좋은 소재를 골라줘. 자료에 없는 내용은 추측하지 마. 선정 기준: 1) 후킹력 있는 소재(반전, 놀라운 사실, 논란, 사고), 2) 시각 자료(영상·사진)가 있을 법한 소재, 3) 항공 인증·안전 전문성을 보여줄 수 있는 소재. 최대 3개까지만 선정하고, 마땅한 소재가 전혀 없으면 다른 말 없이 '오늘은 특별한 소재가 없습니다'라고만 답해.\n\n[뉴스]\n{news_text}\n\n[해외검색]\n{global_search}\n\n[국내검색]\n{korea_search}\n\n형식:\n🎬 *숏폼/카드뉴스 소재 후보 | {today}*\n\n1️⃣ *[후킹 한 줄 제목]*\n📍 소재: 무슨 일이 있었는지 2~3문장\n💡 왜 소재로 좋은지: 반전·놀라움·논란 포인트 1문장\n🎥 형식 제안: 숏폼 영상 또는 카드뉴스 중 추천 + 이유 1문장\n🔗 출처: 링크\n\n(소재가 더 있으면 2️⃣ 3️⃣로 이어서, 최대 3개)"}])
